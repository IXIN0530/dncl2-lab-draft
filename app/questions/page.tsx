  ...
  return (
    <div className="px-4 max-w-xl mx-auto">
      ...
      <div className=" mt-1 flex flex-col bg-2 rounded-2xl">
        {expectedItems.map((items) => <Link className=" py-2 border-b border-gray-300 last:border-none block justify-center text-center" href={items.href}>{items.title}</Link>)}
      </div>
